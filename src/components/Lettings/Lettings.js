    ...
    <div className="lettings-container container my-5">
      ...
      <div className="row align-items-center mb-5 fade-in">
        <div className="col-lg-6">
          <h2 className="fw-bold text-black section-title mb-3">Lettings</h2>
          ...
          <button className="btn btn-primary mb-3">View Properties</button>
        </div>
        <div className="col-lg-6">
      ...
      <div className="row align-items-center fade-in">
        <div className="col-lg-6 order-lg-2">
          <h2 className="fw-bold text-black section-title mb-3">Stay with us</h2>
          <p className="text-muted">
          ...
          <button className="btn btn-primary mb-3">Explore Options</button>
        </div>
